...
function item_merc_super_djinn:OnAbilityPhaseInterrupted()
    return MercSpawnCommon:OnAbilityPhaseInterrupted()
end

function item_merc_super_djinn:OnAbilityPhaseStart()
...
function item_merc_super_djinn:OnSpellStart()
    MercSpawnCommon:Merc_OnSpellStart(self, "npc_avalore_merc_djinn", 1)
end
