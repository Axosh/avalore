...
function modifier_grappling_hook:IsDebuff()
	return false
end

function modifier_grappling_hook:IsStunDebuff()
	return false
end

function modifier_grappling_hook:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_grappling_hook:OnCreated( kv )
	print("modifier_grappling_hook:OnCreated")
...
function modifier_grappling_hook:OnRefresh( kv )
	if not IsServer() then return end
...
function modifier_grappling_hook:OnRemoved()
end

function modifier_grappling_hook:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_grappling_hook:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion Effects
function modifier_grappling_hook:UpdateHorizontalMotion( me, dt )
...
function modifier_grappling_hook:OnHorizontalMotionInterrupted()
	-- destroy
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_grappling_hook:PlayEffects( target )
	-- Get Resources
