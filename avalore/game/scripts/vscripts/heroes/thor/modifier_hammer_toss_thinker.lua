...
function modifier_hammer_toss_thinker:IsDefault() return false end
function modifier_hammer_toss_thinker:IsPurgable() return false end

function modifier_hammer_toss_thinker:OnCreated(kv)
...
function modifier_hammer_toss_thinker:OnIntervalThink()
	...
	local thinker = CreateModifierThinker(
		...
		"modifier_hammer_trail", -- modifier name
		{
...
function modifier_hammer_toss_thinker:Delay()
    self:PlayEffects1()
...
function modifier_hammer_toss_thinker:PlayEffects1()
	-- Get Resources
...
function modifier_hammer_toss_thinker:PlayEffects2()
