...
function CAvaloreGameMode:_OnGameRulesStateChange(event)
	...
	if newState == DOTA_GAMERULES_STATE_PRE_GAME then
		...
		radiant_base_dummy:AddNewModifier(radiant_base_dummy, nil, "modifier_no_healthbar", {})
		...
		dire_base_dummy:AddNewModifier(dire_base_dummy, nil, "modifier_no_healthbar", {})
	...
	if abilityname:find("talent") == 1 then
		...
		if modif then
			if modif:GetName() == "modifier_talent_synergy" or modif:GetName() == "modifier_talent_endurance" or modif:GetName() == "modifier_talent_grappling_hold" then
				...
				hero:AddNewModifier(hero, ability_parent, mod_name, {})
				...
				if enk_ability:GetLevel() > 0 then
					...
					if enkidu then
						enkidu:AddNewModifier(hero, ability_parent, mod_name, {})
					end
				end
			end
		end
