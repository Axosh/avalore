-- NOTE: There is a built-in modifier called "modifier_knockback"
--       so we need to distinguish ours from Valve's
modifier_knockback_avalore = modifier_knockback_avalore or class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_knockback_avalore:IsHidden()
	return true
end

function modifier_knockback_avalore:IsPurgable()
	return false
end

function modifier_knockback_avalore:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

-- function modifier_knockback_avalore:Test()
-- 	print("[modifier_knockback_avalore] Hello")
-- end
--------------------------------------------------------------------------------
-- Initializations
function modifier_knockback_avalore:OnCreated( kv )
	--print("[modifier_knockback_avalore] Started OnCreated")
	if IsServer() then
...
function modifier_knockback_avalore:OnRefresh( kv )
	if not IsServer() then return end
end

function modifier_knockback_avalore:OnDestroy( kv )
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Setter
function modifier_knockback_avalore:SetEndCallback( func )
	self.EndCallback = func
end

--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_knockback_avalore:DeclareFunctions()
	local funcs = {
...
function modifier_knockback_avalore:GetOverrideAnimation( params )
	if self.anim==1 then
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_knockback_avalore:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion effects
function modifier_knockback_avalore:UpdateHorizontalMotion( me, dt )
...
function modifier_knockback_avalore:OnHorizontalMotionInterrupted()
	if IsServer() then
...
function modifier_knockback_avalore:UpdateVerticalMotion( me, dt )
	-- set time
...
function modifier_knockback_avalore:OnVerticalMotionInterrupted()
	if IsServer() then
		self.interrupted = true
		self:Destroy()
	end
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_knockback_avalore:GetEffectName()
	if not IsServer() then return end
	if self.stun then
...
function modifier_knockback_avalore:GetEffectAttachType()
	if not IsServer() then return end
