modifier_knockback = modifier_knockback or class({})
...
function modifier_knockback:IsPurgable()
	return false
end

function modifier_knockback:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
--------------------------------------------------------------------------------
-- Initializations
function modifier_knockback:OnCreated( kv )
	print("Created modifier_knockback")
	if IsServer() then
...
function modifier_knockback:OnRefresh( kv )
	if not IsServer() then return end
end

function modifier_knockback:OnDestroy( kv )
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Setter
function modifier_knockback:SetEndCallback( func )
...
function modifier_knockback:UpdateVerticalMotion( me, dt )
	-- set time
...
function modifier_knockback:OnVerticalMotionInterrupted()
	if IsServer() then
		self.interrupted = true
		self:Destroy()
	end
